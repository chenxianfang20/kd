...
static CGFloat cityPickViewHeigh = 210;
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view{
    ...
    for(UIView *singleLine in pickerView.subviews)
    {
        ...
        {
            singleLine.backgroundColor = [UIColor colorWithRed:236/255.0 green:236/255.0 blue:236/255.0 alpha:1.0];
        }
    }
    return label;
}
...
- (UIView *)toolsView{
    ...
    if (!_toolsView) {
        ...
        UILabel* lineLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 39, self.frame.size.width, 0.3)];
        lineLabel.backgroundColor=[UIColor colorWithRed:245/255.0 green:245/255.0 blue:245/255.0 alpha:1];
        [_toolsView addSubview:lineLabel];
    }
    return _toolsView;
}
...
- (UIButton *)sureButton{
    if (!_sureButton) {
        _sureButton = ({
            ...
            [sureButton setTitleColor:[UIColor colorWithRed:86/255.0 green:174/255.0 blue:44/255.0 alpha:1] forState:UIControlStateNormal];
