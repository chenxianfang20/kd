...
-(UIView *)headerView{
    ...
    if (!_headerView) {
        _headerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kScreenWidth - 36, 50)];
...
-(UITableView *)tableView{
    ...
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, self.headerView.height, kScreenWidth - 36, 459 - 104 - 30) style:UITableViewStylePlain];
    }
    return _tableView;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    KDWuliuListModel *model = self.wuliuArr[indexPath.row];
