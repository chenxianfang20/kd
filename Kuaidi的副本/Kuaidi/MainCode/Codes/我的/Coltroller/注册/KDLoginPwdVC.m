...
-(void)addChildViews{
    ...
    [registerBtn setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHex:@"#F1F1F1"]] forState:UIControlStateNormal];
    registerBtn.layer.cornerRadius=kAdaptationWidth(2);
    registerBtn.layer.masksToBounds=YES;
    [registerBtn addTarget:self action:@selector(registerBtnClick) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:registerBtn];
    
    //同意条例
    UIButton* agreeBtn =[[UIButton alloc]initWithFrame:CGRectMake(kAdaptationWidth(36),registerBtn.bottom+ kAdaptationWidth(17), kAdaptationWidth(20), kAdaptationWidth(20))];
